...
public class SolapamientoA {

    private SolapamientoA() {}
	...
	try {
		...
		System.out.println("Solapamiento A.");
		System.out.println("Las operaciones de las transacciones se ejecutan de manera concurrente sin problemas");
		System.out.println();
